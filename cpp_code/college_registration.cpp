/*The college management system helps to keep records of students' tuition fees. The code asks if the student is in-state or out-of-state. 
For the purpose of calculating the tuition fees, it also asks for the health insurance plan. It then displays the details upon request. 
